...
local library = utility.table({theme = table.clone(themes.AirHub), folder = "Roblox V2", extension = "cfg", flags = {}, open = false, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:Load(options)
	...
	local name = "Roblox V2"
	local sizeX = options.sizex or 450
	local sizeY = options.sizey or 500
	local theme = options.theme and options.theme or "Roblox Theme"
